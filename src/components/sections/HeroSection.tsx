...
// Function to get next 3 consecutive workshop dates in UAE timezone
const getWorkshopDates = () => {
  const dates = [];
  const nowUAE = DateTime.now().setZone("Asia/Dubai");
  for (let i = 0; i < 3; i++) {
    const sessionDate = nowUAE
      .plus({ days: i })
...
const formatWorkshopDateRange = (dates: DateTime[]): string => {
  if (dates.length === 0) return "";
  const firstDate = dates[0];
  const lastDate = dates[dates.length - 1];
  if (firstDate.month !== lastDate.month) {
    return `${firstDate.day} ${firstDate.toFormat("LLLL")} - ${lastDate.day} ${lastDate.toFormat("LLLL")}`;
  }
  return `${firstDate.day}-${lastDate.day} ${firstDate.toFormat("LLLL")}`;
};
...
const formatWorkshopDateTime = (
  ...
  const dateStr = `${date.toFormat("cccc")}, ${date.toFormat("LLL d")}`;
  const timeStr = "6:00 PM - 6:30 PM UAE";
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Left Content Column - Mobile: order-1, Desktop: order-1 */}
            <div className="order-1 md:order-1 space-y-6">
              {/* Workshop Date Section - Moved to top for mobile */}
              <motion.div
              ...
              >
                <div className="relative inline-block">
                  ...
                  <div className="relative bg-white rounded-2xl px-5 py-3 flex items-center gap-3 shadow-xl min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        ...
                        <span>6:00-6:30 PM UAE</span> {/* <-- Change IST to UAE */}
                      </div>
                    </div>
                  ...
                  {/* Decorative elements - smaller for better proportion */}
                  <motion.div
              ...
              >
                <h1 className="font-dingdong text-3xl md:text-4xl lg:text-5xl text-white leading-tight">
                  Turn Your Toddler Into a Confident Reader — Before School Even
                  Starts
              ...
              >
                ...
                >
                  Join our 3-day, World's Highest-Rated, Online Workshop for
                  Parents.
                  <span className="block mt-2">
                    Not Your Regular Phonics Class, but a Simple, Science-Backed
                    Way to Get Your Child Reading 2nd-Grade Books in 90 Days
                    with Just 15 Minutes a Day.
                  </span>
                </p>
              </motion.div>

              {/* CTA Button - Shows first on mobile */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  >
                    Join Risk-Free — 100% Money-Back Guarantee
                  </p>
                </motion.div>
              </motion.div>

              {/* Hero Image - Moved down for mobile, order-2 */}
              <motion.div
                className="relative md:hidden order-2"
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ delay: 0.2, duration: 0.8 }}
              >
                {/* Main Hero Image for mobile */}
                <div className="relative rounded-2xl overflow-hidden border-4 border-white/30 shadow-2xl">
                  ...
                  {/* Interactive image overlay - mobile simplified */}
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-t from-pink-700/60 via-transparent to-transparent flex items-end"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  >
                    <div className="p-4 w-full">
                      <div
                        className={`bg-white/95 backdrop-blur-md rounded-xl p-4 transform -rotate-1 shadow-xl max-w-sm mx-auto ${andika.className}`}
                      >
              ...
              {/* Testimonial Quote - After hero image on mobile */}
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              {/* Star Rating - After testimonial */}
              <motion.div
                className="flex items-center justify-start gap-2 order-4"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <div className="md:hidden grid grid-cols-3 gap-2 mt-4 order-5">
            ...
            <motion.div
              className="relative order-2 md:order-last hidden md:block"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden border-4 border-white/30 shadow-2xl">
                ...
                {/* Interactive image overlay - Desktop full version */}
                <motion.div
