    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative mt-16">
          <div className="relative max-w-7xl mx-auto px-20"> {/* Added relative and px-20 here */}
            {/* Previous Button */}
            <motion.button
              className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-white/90 rounded-full p-4 shadow-lg text-pink-600 hover:bg-white"
              onClick={() => paginate(-1)}
            ...
            {/* Videos Grid - Removed padding here since it's on parent */}
            <motion.div
            ...
            >
              {[0, 1, 2].map((offset) => {
                const currentIndex = (videoIndex + offset) % students.length;
            ...
            {/* Next Button */}
            <motion.button
              className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-white/90 rounded-full p-4 shadow-lg text-pink-600 hover:bg-white"
              onClick={() => paginate(1)}
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
            >
