...
export const TestimonialsSection = ({ id }: { id?: string }) => {
  ...
  const testimonials = [
    ...
    },
    {
      id: 103,
      imageUrl:
        "/testimonials/Set 5/fab-testimonial-trustpilot-20210530-fab-testimonial-trustpilot-20210528-diyaparamananandani.png",
      rating: 5,
      childAge: 4,
    },
    {
      id: 104,
      imageUrl:
        "/testimonials/Set 5/fab-testimonial-trustpilot-20210530-fab-testimonial-trustpilot-20210528-faizuhenaart.png",
      rating: 5,
      childAge: 3,
    },
    {
      id: 105,
      imageUrl:
        "/testimonials/Set 5/fab-testimonial-trustpilot-20210530-fab-testimonial-trustpilot-20210528-farsanaubaid.png",
      rating: 5,
      childAge: 5,
    },
    ];
